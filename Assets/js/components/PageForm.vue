                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-footer pb-0">
                                <el-form-item>
                                    ...
                                    <el-button @click="onCancel()">{{ trans('core.button.cancel') }}</el-button>
                                </el-form-item>
                        </div>
                    </div>
                </div>
                <div class="col-2">
                    <div class="card card-primary">
                        <div class="card-body">
                            ...
                            <tags-input namespace="asgardcms/page" :placeholder="'Selecciona'" v-model="tags" :current-tags="tags" :label="trans('pages.tags')"></tags-input>

                            <single-media zone="image" @single-file-selected="selectSingleFile($event, 'page')"
                                          entity="Modules\Page\Entities\Page" :entity-id="$route.params.pageId" :label="'Imagen'"></single-media>
                        </div>
                    </div>
                </div>
            </div>
